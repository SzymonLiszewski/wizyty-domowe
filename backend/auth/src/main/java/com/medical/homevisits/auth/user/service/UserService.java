...
public class UserService {
    ...
    public void create(User user){
        ...
        if (user instanceof Doctor){
            ...
            userEventRestRepository.createParamedic(new CreateParamedicObject(user.getID(), user.getFirstName(), user.getLastName(),((Paramedic) user).getSpecialization(), ((Paramedic) user).getWorkPlace()));
        }
