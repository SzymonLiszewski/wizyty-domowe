    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val appointments = listOf(
            Appointment(
                ...
                doctor = Doctor("1", "Jan", "Kowalski", "laryngolog"),
                patient = Patient("1"),
            ...
            Appointment(
                ...
                doctor = Doctor("2", "Jan", "Kowalski", "ginekolog"),
                patient = Patient("2"),
            ...
            Appointment(
                ...
                doctor = Doctor("3", "Jan", "Kowalski", "urolog"),
                patient = Patient("1"),
                address = "123 Main Street",
                notes = null
            ),
            Appointment(
                ...
                doctor = Doctor("4", "Jan", "Kowalski", "chirurg"),
                patient = Patient("2"),
                address = "456 Elm Street",
                notes = null
            ),
            Appointment(
                ...
                Doctor("5", "Jan", "Kowalski", "laryngolog"),
                patient = Patient("1"),
                address = "123 Main Street",
                notes = null
            ),
            Appointment(
                ...
                Doctor("6", "Jan", "Kowalski", "laryngolog"),
                patient = Patient("2"),
                address = "456 Elm Street",
                notes = null
            ),
            Appointment(
                ...
                Doctor("7", "Jan", "Kowalski", "pediatra"),
                patient = Patient("1"),
                address = "123 Main Street",
                notes = null
            ),
            Appointment(
                ...
                Doctor("8", "Jan", "Kowalski", "pediatra"),
                patient = Patient("2"),
                address = "456 Elm Street",
                notes = null
            ),
            Appointment(
                ...
                Doctor("9", "Jan", "Kowalski", "pediatra"),
                patient = Patient("1"),
                address = "123 Main Street",
                notes = null
            ),
            Appointment(
                ...
                Doctor("10", "Jan", "Kowalski", "psycholog"),
                patient = Patient("2"),
                address = "456 Elm Street",
                notes = null
            )
